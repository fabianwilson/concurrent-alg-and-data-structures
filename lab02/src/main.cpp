...
bool test_final_state() {
    ...
    worker_thread_func<StdSet, SetOperator>(&validation_set, &generator1);

    Set test_set;
    OpGenerator<SetOperator> generator2(DEFAULT_SET_GEN_WEIGHTS, op_count, max_num, DEFAULT_GENERATOR_SEED);
    worker_thread_func<Set, SetOperator>(&test_set, &generator2);
...
int task_4() {
    ...
    std::cout << "# Task 4: FineSet" << std::endl;
    std::cout << std::endl;
...
int task_5() {
    std::cout << "# Task 5: Benchmarking" << std::endl;
    std::cout << std::endl;
...
int task_8() {
    bool valid = true;
    std::cout << "# Task 8: `FineMultiset`" << std::endl;
